...
- Wrote a python script that retrieves fantasy football draft data from Sleeper API, puts it in a pandas dataframe, merges it with with stats from the season, and exports as a the dataframe csv.
