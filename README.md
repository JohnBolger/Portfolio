...
- Wrote a python script that retrieves fantasy football draft data from Sleeper API and merges draft data with with stats from the season and then exports as a the dataframe csv.
